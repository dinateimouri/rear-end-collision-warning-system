...
Steeringdata= MyDataSet_2;
Steeringdata(:,[6 7 8 9 10])=[];

save Steeringdata Steeringdata


%%
Steeringwarndata = Steeringdata(Steeringdata(:,end)==1,:);
Steeringsafedata = Steeringdata(Steeringdata(:,end)==0.5,:);

save Steeringsafedata Steeringsafedata
save Steeringwarndata Steeringwarndata
